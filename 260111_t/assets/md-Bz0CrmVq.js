...
0xCA0  KANNADA LETTER TTHA
 ...
 $\\___/$ @
         @@
         `,De="/slidev-math-videos/";function $e(){return De}const Be={class:"my-auto w-full"},ke=z({__name:"cover",props:{background:{default:""}},setup(s){k();function l(){const C=g_.textSync("hans-green-theme",{font:"Standard"});console.log(C),console.log("🌟🌟 本PPT原作者：%cHans码数理哲","color: #16a34a; font-weight: bold; font-size: 30px;","🌟🌟")}const E=s,c=$(()=>We(E.background,!0)),A=`${$e()}live2d/`;function m(C,g){return new Promise((p,H)=>{let N;g==="css"?(N=document.createElement("link"),N.rel="stylesheet",N.href=C):g==="js"&&(N=document.createElement("script"),N.type="module",N.src=C),N&&(N.onload=()=>p(C),N.onerror=()=>H(C),document.head.appendChild(N))})}async function S(){const C=window.Image;window.Image=function(...g){const p=new C(...g);return p.crossOrigin="anonymous",p},window.Image.prototype=C.prototype;try{await Promise.all([m(`${A}waifu.css`,"css"),m(`${A}waifu-tips.js`,"js")])}catch(g){console.error("加载 waifu.css 和 waifu-tips.js 失败",g)}initWidget({waifuPath:`${A}waifu-tips.json`,cubism2Path:`${A}live2d.min.js`,cubism5Path:`${A}cubism5/live2dcubismcore.js`,tools:["hitokoto","asteroids","switch-model","switch-texture","photo","info","quit"],logLevel:"warn",drag:!0})}return T_(()=>{g_.parseFont("Standard",be),l(),S(),console.log(`
%cLive2D%cWidget%c
