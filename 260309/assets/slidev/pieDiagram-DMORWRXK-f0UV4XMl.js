import{p as U}from"./chunk-K2ZEYYM2-BW-FI8ZE.js";import{p as V}from"./treemap-KMMF4GRG-YVX6V4UE-DMEweGM0.js";import{b as s,g as Z,s as j,c as q,d as H,x as J,v as K,l as w,e as Q,I as X,aP as Y,aR as ee,aS as G,aT as te,h as ae,B as re,aU as ie,L as se}from"./two-cols.vue_vue_type_script_setup_true_lang-DxHctyEZ.js";import"./chunk-ZZTYOBSU-CQYGQi4t.js";import"../index-BI6M3uxz.js";import"../modules/vue-Dr2tpcp3.js";import"../modules/shiki-DRAmv-Bm.js";import"../modules/file-saver-B7oFTzqn.js";var le=se.pie,D={sections:new Map,showData:!1},g=D.sections,C=D.showData,oe=structuredClone(le),ne=s(()=>structuredClone(oe),"getConfig"),ce=s(()=>{g=new Map,C=D.showData,re()},"clear"),de=s(({label:e,value:a})=>{if(a<0)throw new Error(`"${e}" has invalid value: ${a}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);g.has(e)||(g.set(e,a),w.debug(`added new section: ${e}, with value: ${a}`))},"addSection"),pe=s(()=>g,"getSections"),ge=s(e=>{C=e},"setShowData"),ue=s(()=>C,"getShowData"),P={getConfig:ne,clear:ce,setDiagramTitle:K,getDiagramTitle:J,setAccTitle:H,getAccTitle:q,setAccDescription:j,getAccDescription:Z,addSection:de,getSections:pe,setShowData:ge,getShowData:ue},fe=s((e,a)=>{U(e,a),a.setShowData(e.showData),e.sections.map(a.addSection)},"populateDb"),he={parse:s(async e=>{const a=await V("pie",e);w.debug(a),fe(a,P)},"parse")},me=s(e=>`
  .pieCircle{
