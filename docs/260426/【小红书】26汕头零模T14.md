...
$$
\begin{align}
&S_{36} = S_{37} - a_{37} = 703 - a_{37} \\
&\implies a_{37} \mid (703 - a_{37}) \\
&\implies a_{37} \mid (19 \times 37)
\end{align}
...
下面我们考虑怎么对这题进行**扩展**。首先，37是素数，不难想到：数列的项数n应为**奇素数**，设为p（注：p为素数+ $\frac{p+1}{2}$ 为正整数等价于p为**奇素数**）。
